...
app.get('/api/trades', (req, res) => {
  res.json([
    { timestamp: '2025-02-11T19:33:00', trader_address: '0xdb27c56e1234567890abcdef', bucket: 'event', market_id: '0xd08c51ab1d', market_name: 'Rams vs. Bears', side: 'CLOSE_Bears', price: 0.34, size_usd: 3.34, pnl: 0.42, resolved: 1, status: 'simulated', notes: 'Simulated close. 9.82 tokens. PnL: $0.42' },
    { timestamp: '2025-02-11T19:33:00', trader_address: '0xdb27c56e1234567890abcdef', bucket: 'event', market_id: '0xab4fab2240', market_name: 'Will Liverpool FC win?', side: 'CLOSE_No', price: 0.48, size_usd: 3.34, pnl: -0.12, resolved: 1, status: 'simulated', notes: 'Simulated close. 6.94 tokens. PnL: $-0.12' },
    { timestamp: '2025-02-11T19:33:00', trader_address: '0xdb27c56e1234567890abcdef', bucket: 'event', market_id: '0x393557eaf4', market_name: 'Patriots vs. Broncos', side: 'CLOSE_Broncos', price: 0.33, size_usd: 3.34, pnl: 0.55, resolved: 1, status: 'simulated', notes: 'Simulated close. 10.04 tokens. PnL: $0.55' },
    { timestamp: '2025-02-11T19:30:00', trader_address: '0xabcdef1234567890abcdef12', bucket: 'grinder', market_id: '0xaa11bb22', market_name: 'Bitcoin above $100K by March?', side: 'Yes', price: 0.62, size_usd: 2.10, pnl: 0, resolved: 0, status: 'executed', notes: 'Filled at 0.62' },
    { timestamp: '2025-02-11T19:28:00', trader_address: '0xdb27c56e1234567890abcdef', bucket: 'event', market_id: '0x1234', market_name: 'Thunder vs. Warriors', side: 'Warriors', price: 0.18, size_usd: 3.34, pnl: 0, resolved: 0, status: 'risk_blocked', notes: 'Total exposure ($20.04) would exceed limit ($16.7)' },
    { timestamp: '2025-02-11T19:28:00', trader_address: '0xdb27c56e1234567890abcdef', bucket: 'event', market_id: '0x5678', market_name: 'Lakers vs. 76ers', side: '76ers', price: 0.41, size_usd: 0, pnl: 0, resolved: 0, status: 'no_position', notes: 'No matching open position found' },
    { timestamp: '2025-02-11T19:20:00', trader_address: '0xabcdef1234567890abcdef12', bucket: 'grinder', market_id: '0xcc33dd44', market_name: 'ETH above $4K in Feb?', side: 'No', price: 0.75, size_usd: 1.80, pnl: 0.35, resolved: 1, status: 'executed', notes: 'Filled at 0.75' },
    { timestamp: '2025-02-11T19:15:00', trader_address: '0xdb27c56e1234567890abcdef', bucket: 'event', market_id: '0xee55ff66', market_name: 'Super Bowl LVIX Winner', side: 'Chiefs', price: 0.55, size_usd: 4.20, pnl: -0.80, resolved: 1, status: 'executed', notes: 'Filled at 0.55' },
  ]);
});
